...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'soundlush-format-video' ); ?>>

  <header class="entry-header">

    <div class="embed-responsive widescreen"><?php echo wpsl_get_embedded_media( array( 'video', 'iframe' ) ); ?></div>
